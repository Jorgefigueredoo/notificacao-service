...
public class NotificacaoConsumer {
    ...
    public void receberEventoConsultaAgendadada(@Payload ConsultaAgendadaEvent evento) {
        ...
        if (Objects.nonNull(usuario) && Objects.nonNull(usuario.email())) {

            String respostaGemini = geminiClient.gerarMensagemCorpoEmail(usuario.endereco());

            LocalDate data = extrairDataConsulta(evento.datahora());
            LocalTime hora = extrairHoraConsulta(evento.datahora());
